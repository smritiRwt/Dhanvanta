    ...
    <div className="home-page single-page">
      ...
      <section id="services" className="content-section services-section">
        ...
        <div className="service-grid">
          <article><div className="service-icon" aria-hidden="true"><Percent size={34} strokeWidth={2}/></div><span className="service-index">01</span><h3>Tax Planning</h3><p>Plan your taxes and explore ways to create a tax-efficient retirement fund.</p><details className="service-why"><summary>Why important</summary><p>Smart tax planning can reduce unnecessary tax outgo and keep more of your money working towards long-term goals.</p></details></article>
          <article><div className="service-icon" aria-hidden="true"><Landmark size={34} strokeWidth={2}/></div><span className="service-index">02</span><h3>Loans</h3><ul className="service-list"><li>Personal loans</li><li>Home loans</li><li>Car loans</li><li>Property loans</li><li>Business loans</li><li>Loan against securities</li></ul><details className="service-why"><summary>Why important</summary><p>Choosing the right loan and repayment plan helps you fund important goals without creating avoidable debt stress.</p></details></article>
          <article><div className="service-icon" aria-hidden="true"><HeartPulse size={34} strokeWidth={2}/></div><span className="service-index">03</span><h3>Health Insurance</h3><p>Prepare for hospitalisation, day-care treatment, medical expenses, and cashless care.</p><details className="service-why"><summary>Why important</summary><p>Health cover protects your savings from unexpected medical expenses and helps your family access timely care.</p></details></article>
        </div>
      </section>
